...
impl Wait {
    ...
    pub fn tool_input(name: impl Into<String>, fragment: impl Into<String>) -> Self {
        Self::on(Expect::tool_input(name, fragment))
    }

    pub fn tool_result_contains(name: impl Into<String>, fragment: impl Into<String>) -> Self {
        Self::on(Expect::tool_result_contains(name, fragment))
    }

    pub fn tool_result_error(name: impl Into<String>, is_error: bool) -> Self {
        Self::on(Expect::tool_result_error(name, is_error))
    }

    pub fn text_regex(pattern: &str) -> crate::Result<Self> {
        Ok(Self::on(Expect::text_regex(pattern)?))
    }
